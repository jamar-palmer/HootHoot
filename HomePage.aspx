...
<body>
    ...
    <div class="col-md-6 mb-6 d-flex flex-column ">
              <asp:Button ID="Button1" runat="server" Text="View Courses" OnClick="Button1_Click" />
        </div>
        <div class="col-md-6 mb-6 d-flex flex-column ">
              <asp:Button ID="Button2" runat="server" Text="Plan Registration" OnClick="Button2_Click" />
              <br />
            </div>
